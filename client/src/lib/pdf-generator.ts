...
function addNmcHeader(doc: jsPDF, title: string) {
  // Add "RevalPro" as header text (using app name instead of NMC to avoid trademark issues)
  doc.setFontSize(22);
  doc.setTextColor(NMC_BLUE[0], NMC_BLUE[1], NMC_BLUE[2]);
  doc.text("RevalPro", 20, 20);
  ...
  doc.text("This is not an official NMC document. Forms generated by RevalPro for submission to NMC.", 20, 40);
