        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="mailto:support@revalpro.co.uk" className="text-gray-400 hover:text-white transition-colors">support@revalpro.co.uk</a></li>
                <li className="text-gray-400">London, United Kingdom</li>
              </ul>
              <div className="flex space-x-4 mt-4">
                <a href="https://www.facebook.com/profile.php?id=61571637733696" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
