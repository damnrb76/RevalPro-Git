...
export const PLAN_DETAILS: Record<SubscriptionPlan, PlanDetails> = {
  free: {
    ...
    features: [
      ...
      { title: "PDF export", included: true, limit: "basic" },
      ...
      { title: "Document storage", included: false },
      { title: "Feedback collection", included: false },
      { title: "Premium support", included: false },
    ],
  },
  standard: {
    id: "standard",
    ...
    features: [
      ...
      { title: "Document storage", included: true, limit: "100MB" },
      { title: "Feedback collection", included: true },
      { title: "Premium support", included: false },
    ],
  },
  premium: {
    ...
    features: [
      ...
      { title: "Comprehensive CPD logging", included: true },
      { title: "Unlimited reflective accounts", included: true },
      { title: "Advanced PDF export", included: true, highlighted: true },
      { title: "NMC revalidation guidance", included: true },
      { title: "Reminders and notifications", included: true },
      { title: "Advanced AI-assisted templates", included: true, highlighted: true },
      { title: "Document storage", included: true, limit: "Unlimited", highlighted: true },
      { title: "Feedback collection & analysis", included: true, highlighted: true },
      { title: "Premium support", included: true, highlighted: true },
    ],
  },
};
